...
Zapnutie Dockeru. Otvorenie a spustenie súboru docker-compose.yml. Po úspešnom spustení by sa mali v Dockery v sekcii Containers objaviť nasledovné položky: adminer - spravovanie databázy mariadb - databáza thevajko/vaii-web-server:main - stránka
